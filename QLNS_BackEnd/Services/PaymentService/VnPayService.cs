...
namespace QLNS_BackEnd.Services.PaymentService
{
    public class VnPayService : IVnPayService
    {
        ...
        public async Task<string> CreatePaymentUrl(HttpContext context, VnPaymentRequestModel request)
        {
        ...
        public async Task<VNPayResponseModel> PaymentExecute(IQueryCollection collection)
        {
            var vnPay = new VnPayLibrary();
